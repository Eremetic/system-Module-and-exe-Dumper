...
static BOOL SetHardwareBreakingPnt(IN HANDLE hThread, IN DWORD pAddress, IN _DRX Drx)
{
...
BOOL Hardware_Breakpoint_Main(IN HANDLE hThread, IN WCHAR* exeName)
{
	...
	if (!SetHardwareBreakingPnt(hThread, pAddress, Dr0))
	{
	...
	printf_s("\033[0;32m[+]\033[0mResuming Thread Execution\033[0m\n");
